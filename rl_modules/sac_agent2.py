...
class SACAgent:
    ...
    def act(self, obs, ag, g, self_eval):
        with torch.no_grad():
            ...
            if self.architecture == 'deepsets':
                ...
                self.model.policy_forward_pass(obs_tensor, ag_norm, g_norm, eval=self_eval)
                ...
                action = self._select_actions(input_tensor, eval=self_eval)
            else:
